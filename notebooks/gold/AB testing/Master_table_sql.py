...
# DBTITLE 1,Create master table using SQL (optimized)
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE second_data_engineering_project.gold.orders_master_mv
...
# MAGIC %sql
# MAGIC SELECT COUNT(*) as total_records FROM second_data_engineering_project.gold.orders_master_mv
...
print(f"✅ Materialized view created: second_data_engineering_project.gold.orders_master_mv")
